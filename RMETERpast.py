...
class R_Meter:
        ...
        def __init__(self, bus=0, spi_channel=0, bus2=1, spi_channel2=0, S1=25, S2=6, S3=5, polarityIO=16):
                ...
                # GPIO.output(self.S2,GPIO.LOW)
                # GPIO.output(self.S3,GPIO.LOW)
                hardConf.localGPIO.set_mode(self.S1, hardConf.gpio_OUTPUT)
                hardConf.localGPIO.set_mode(self.S2, hardConf.gpio_OUTPUT)
                hardConf.localGPIO.set_mode(self.S3, hardConf.gpio_OUTPUT)
                hardConf.localGPIO.set_mode(self.polarityIO, hardConf.gpio_OUTPUT)
                hardConf.localGPIO.write(self.S1, 0)
                hardConf.localGPIO.write(self.S2, 0)
                hardConf.localGPIO.write(self.S3, 0)
