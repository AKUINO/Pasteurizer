...
class _ABEHelpers:
    ...
    def get_smbus():
        ...
        try:
            ...
            raise Exception('Could not open the i2c bus')
...
class ADC:
    ...
    def __init__(self):
        ...
        self.__spiADC.max_speed_hz = (190000)
    ...
    def write_pin(self, pin, value):
        ...
        if pin < 8:
            ...
            try:
                ...
                print ("%s[%s]=%s" % (str(self.__port_b_value), str(pin-8), str(value)))
        return
